...
public class JalaliCalendar extends Calendar {
    private static final long serialVersionUID = 2543505509607136606L;
    ...
    public static class YearMonthDate {
        ...
        public String toFullString() {
            String tmpM = String.format(Locale.ENGLISH, "0%d", getMonth() + 1);
            String tmpD = String.format(Locale.ENGLISH, "0%d", getDate());
            return getYear() + "/" + tmpM.substring(tmpM.length() - 2) + "/" + tmpD.substring(tmpD.length() - 2);
        }
    }
}
